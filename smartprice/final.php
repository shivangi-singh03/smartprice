...
<html>
    ...
    <body>
	   ...
	   echo '
		...
		<div class="w3-card-2" style="color:teal;text-align:center;font-style:bold;">
		<br>
	  ...
	  echo '
       ...
       echo '<h2 style="font-size: 25px ;color: teal">Specifications:</h2><br>';
	  ...
	  echo '
       ...
       echo '<br><h2 style="font-size: 25px ;color: teal">Specifications:</h2>';
